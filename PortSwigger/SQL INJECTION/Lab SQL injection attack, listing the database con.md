...
![image.png](Lab%20SQL%20injection%20attack,%20listing%20the%20database%20con/image.png)

đầu tiên là chúng ta sẽ check số bảng có trong cơ sở liệu và tìm bẳng có chứa thông tin mà chúng ta cần truy cập

![image.png](Lab%20SQL%20injection%20attack,%20listing%20the%20database%20con/image%201.png)
...
![image.png](Lab%20SQL%20injection%20attack,%20listing%20the%20database%20con/image%202.png)
